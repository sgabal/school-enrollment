...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def algebra1 = new Course(
                ...
                status: 'OPEN', size: 10, maxSize: 15, subject:'Mathematics'
        ).save(flush: true)
        ...
        def algebra2 = new Course(
                ...
                prerequisite: 'NONE', location: 'TCEASTBANK ', instructor: 'Roberts, Bob',
                status: 'OPEN', size: 15, maxSize: 15, subject:'Mathematics'
        ).save(flush: true)
        ...
        def geometry = new Course(
                ...
                status: 'OPEN', size: 10, maxSize: 25, subject:'Mathematics'
        ).save(flush: true)
        ...
        def calculus1 = new Course(
                ...
                status: 'OPEN', size: 5, maxSize: 15, subject:'Mathematics'
        ).save(flush: true)
        ...
        def calculus2 = new Course(
                ...
                status: 'OPEN', size: 10, maxSize: 30, subject:'Mathematics'
        ).save(flush: true)
